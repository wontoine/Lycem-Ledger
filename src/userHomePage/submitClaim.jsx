...
function SubmitClaimModal({ onClose, userID }) {
    ...
    try {
      const response = await fetch(API_URL, {
        ...
        headers: {
          ...
          "x-user-id": claimData.CustomerID,
        },
      ...
      if (!response.ok) {
        ...
        try {
          ...
          throw new Error(
            `HTTP error! Status: ${response.status} ${e.response}`
          );
        }
      ...
      setError(`Submission failed: ${err.message}. Please check your inputs.`);
    } finally {
